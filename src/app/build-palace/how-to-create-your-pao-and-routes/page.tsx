  ...
  return (
    ...
    >
      <div className="space-y-8">
        <section className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5 md:p-6">
          <ButtonLink href="/build-palace" variant="secondary" className="mb-5">
            <ArrowLeft className="size-4" />
            Back to Build
          </ButtonLink>
          <p className="text-sm font-medium text-[var(--accent)]">Build guide</p>
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5">
            <div className="flex items-center gap-3">
              <span className="flex size-10 items-center justify-center rounded-md bg-[var(--accent-soft)] text-[var(--accent)]">
                <Route className="size-5" />
              </span>
              <div>
                <p className="text-sm font-medium text-[var(--accent)]">Skill 1</p>
          ...
          <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-[var(--accent)]">Skill 2</p>
        ...
        <section className="space-y-4">
          <div>
            <p className="text-sm font-medium text-[var(--accent)]">Routes</p>
          ...
          <div className="grid gap-4 lg:grid-cols-[1fr_380px]">
            <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {routeExamples.map((location, index) => (
                  <span key={location} className="rounded-md border border-[var(--border)] bg-[var(--card-muted)] px-3 py-2 text-sm">
            ...
            <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5">
              ...
              <div className="mt-4 space-y-3 text-sm">
                ...
                <div className="rounded-md bg-[var(--accent-soft)] p-3 text-[var(--accent)]">
          ...
          <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5">
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-5">
              {locationFields.map((field) => (
                <div key={field.label} className="rounded-md bg-[var(--card-muted)] p-3">
                  <p className="text-xs font-semibold uppercase text-[var(--muted)]">{field.label}</p>
        ...
        <section className="space-y-4">
          <div>
            <p className="text-sm font-medium text-[var(--accent)]">PAO</p>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5">
              ...
              <div className="mt-4 grid gap-3">
                {suitCategories.map((item) => (
                  <div key={item.suit} className="rounded-md bg-[var(--card-muted)] p-3">
                    <p className="font-semibold">{item.suit}</p>
                    <p className="text-sm text-[var(--muted)]">{item.meaning}</p>
                    <p className="mt-1 text-sm font-medium text-[var(--accent)]">{item.example}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5">
              <div className="flex items-center gap-3">
                <Film className="size-5 text-[var(--accent)]" />
                <h3 className="text-xl font-semibold">Technique B: Use rank patterns</h3>
              </div>
              <div className="mt-4 grid gap-2 sm:grid-cols-2">
                {rankPatterns.map((pattern) => (
                  <div key={pattern} className="rounded-md bg-[var(--card-muted)] px-3 py-2 text-sm">
                    {pattern}
                  </div>
                ))}
              </div>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5">
              ...
              <div className="mt-4 space-y-2">
                {paoExamples.map((example) => (
                  <div key={example} className="rounded-md bg-[var(--card-muted)] px-3 py-2 text-sm">
                    {example}
                  </div>
                ))}
              </div>
            ...
            <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {imageRules.map((rule) => (
                  <span key={rule} className="rounded-md bg-[var(--ink)] px-3 py-2 text-sm font-medium text-white">
                    {rule}
                  </span>
                ))}
              </div>
        ...
        <section className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-5 md:p-6">
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div>
              <p className="text-sm font-medium text-[var(--accent)]">Next step</p>
